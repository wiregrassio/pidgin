...
compressible meaning and a cost to ambiguity: legal clauses, medical
procedures, infrastructure runbooks, meeting transcripts, image
corpora (JPEG quality as the compression axis, embedding divergence
as the test). Political speeches and executive jargon will reliably
fail to converge. That is the correct output.
